...
static uint32_t rx_char_add(ble_nus_t * p_nus, const ble_nus_init_t * p_nus_init)
{
	...
	/*
	modifications by Sean Beitz : 2016-07-07
	all BLE_GAP_CONN_SEC_MODE_SET_OPEN changed to BLE_GAP_CONN_SEC_MODE_SET_ENC_WITH_MITM with #ifdef SH_ENABLE_ENCRYPTION
	https://devzone.nordicsemi.com/question/57764/add-nus-service-with-bond/
	*/
	
#ifdef SH_ENABLE_ENCRYPTION

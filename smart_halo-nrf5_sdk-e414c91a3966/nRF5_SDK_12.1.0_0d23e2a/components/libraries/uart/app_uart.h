...
/**@brief Function for getting the number of characters in the TX FIFO
 *
 * @details Returns the number of characters currently in the TX FIFO
  *
 * @retval Number of characters in the TX FIFO
 */
uint32_t app_uart_get_nb_tx_fifo_chars();

/**@brief Function for getting the number of characters in the RX FIFO
 *
 * @details Returns the number of characters currently in the RX FIFO
  *
 * @retval Number of characters in the RX FIFO
 */

...
int main(void)
{
  ...
  printf("\r\nApplication started\r\n");
  lcdInit_ST7701Driver(&hspi2);

  displayAllWhitePixels_ST7701Driver(&hspi2);
  printf("LCD initialized\r\n");

  /*
  accelInit(&hi2c1);
  printf("Testing Accel Driver... \r\n");
  */
  ...
  status |= extFlashInit(&hospi1);

  uint8_t data[] = {0xAA, 0x55};
  while (1) {
	  //status |= extFlashGetID(&hospi1, &jid);
    status |= extFlashQuadLoadProgramDataRandom(&hospi1, &data[0], 2, 0);
	  HAL_Delay(1000);
  }
...
void SystemClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_LTDC|RCC_PERIPHCLK_FDCAN
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOI, CHARGE_CE_Pin|LDO_LCD_EN_Pin|LDO_BZR_EN_Pin|BZR_GPIO_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, CHARGE_nTE_Pin|LDO_NRF_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : CHARGE_STAT1_Pin PGOOD_VIN_Pin */
  GPIO_InitStruct.Pin = CHARGE_STAT1_Pin|PGOOD_VIN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : CHARGE_CE_Pin LDO_LCD_EN_Pin LDO_BZR_EN_Pin BZR_GPIO_Pin */
  GPIO_InitStruct.Pin = CHARGE_CE_Pin|LDO_LCD_EN_Pin|LDO_BZR_EN_Pin|BZR_GPIO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOI, &GPIO_InitStruct);

  /*Configure GPIO pins : CHARGE_nTE_Pin LDO_NRF_EN_Pin */
  GPIO_InitStruct.Pin = CHARGE_nTE_Pin|LDO_NRF_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : CHARGE_STAT2_Pin REV_ID_1_Pin */
  GPIO_InitStruct.Pin = CHARGE_STAT2_Pin|REV_ID_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOI, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : REV_ID_0_Pin REV_ID_2_Pin */
  GPIO_InitStruct.Pin = REV_ID_0_Pin|REV_ID_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : REV_ID_3_Pin */
  GPIO_InitStruct.Pin = REV_ID_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(REV_ID_3_GPIO_Port, &GPIO_InitStruct);
...
//#define Error_Handler() Error_Handler_printName(__func__)
//
//void Error_Handler_printName( char const * function_name )
//{
//  __disable_irq();
//  while (1)
//  {

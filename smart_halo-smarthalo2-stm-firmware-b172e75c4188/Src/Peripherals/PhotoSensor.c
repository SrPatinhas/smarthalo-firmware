...
// ================================================================================================
/**
 * @brief       Function to write a photosensor register
 * @public
...
bool photoSensorWriteRegister(uint8_t u8DeviceAddr, uint8_t u8Register, uint8_t * pu8Data, uint16_t u16Length)
{
    ...
    return !HAL_I2C_Write(&SENSOR_I2C, u8DeviceAddr, u8Register, pu8Data, u16Length);
}

/**
 * @brief       Function to read a register from the photosensor
 * @public
 * @param[in]   u8DeviceAddr: I2C Addr
 * @param[in]   u8Register: Register addr.
...
{
    if (pu8Data == NULL) return false;
    return !HAL_I2C_Read(&SENSOR_I2C,  u8DeviceAddr, u8Register, pu8Data, u16Length);
}

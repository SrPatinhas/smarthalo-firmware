...
// ================================================================================================
// ================================================================================================
#define _ENABLE_VBZ_LDO() HAL_GPIO_WritePin(VBZ_LDO_EN_GPIO_Port, VBZ_LDO_EN_Pin, GPIO_PIN_SET)
#define _DISABLE_VBZ_LDO() HAL_GPIO_WritePin(VBZ_LDO_EN_GPIO_Port, VBZ_LDO_EN_Pin, GPIO_PIN_RESET)
...
bool init_PiezoDriver(void)
{
	...
	HAL_TIM_SET_VALUE(&PIEZO_EN_TIMER, PIEZO_EN_TIMER_CH, 500);
	HAL_TIM_SET_STATE(&PIEZO_EN_TIMER, PIEZO_EN_TIMER_CH, false);
...
bool setVolume_PiezoDriver(uint8_t volume)
{
	...
	HAL_TIM_SET_VALUE(&PIEZO_EN_TIMER, PIEZO_EN_TIMER_CH, volume * 10);
	HAL_TIM_SET_STATE(&PIEZO_EN_TIMER, PIEZO_EN_TIMER_CH, true);
	return true;
}
/**
...
static bool piezoConvertFrequency(float freq, uint32_t * toneRegister)
{
   ...
   */
	if(freq)
	    *toneRegister = (uint32_t) (( 60000000 / ( (290+1)*freq ) ) - 1)/2;  
	else
	    *toneRegister = 0;

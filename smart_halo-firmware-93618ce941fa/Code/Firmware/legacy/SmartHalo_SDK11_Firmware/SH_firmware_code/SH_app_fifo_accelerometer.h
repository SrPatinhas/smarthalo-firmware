...
#ifndef SH_FIRMWARE_CODE_SH_APP_FIFO_ACCELEROMETER_H_
#define SH_FIRMWARE_CODE_SH_APP_FIFO_ACCELEROMETER_H_
...
typedef struct
{
	SH_accelerometer_data *          p_buf;           /**< Pointer to FIFO buffer memory.                      */
...
#endif /* SH_FIRMWARE_CODE_SH_APP_FIFO_ACCELEROMETER_H_ */

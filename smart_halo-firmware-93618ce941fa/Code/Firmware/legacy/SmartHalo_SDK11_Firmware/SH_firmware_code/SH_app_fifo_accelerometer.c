...
static __INLINE uint32_t fifo_length(sh_app_fifo_t * p_fifo)
{
...
static __INLINE void fifo_put(sh_app_fifo_t * p_fifo, SH_accelerometer_data byte)
{
...
static __INLINE void fifo_peek(sh_app_fifo_t * p_fifo, uint16_t index, SH_accelerometer_data * p_byte)
{
...
static __INLINE void fifo_get(sh_app_fifo_t * p_fifo, SH_accelerometer_data * p_byte)
{
...
uint32_t SH_app_fifo_init(sh_app_fifo_t * p_fifo, SH_accelerometer_data * p_buf, uint16_t buf_size)
{
...
uint32_t SH_app_fifo_put(sh_app_fifo_t * p_fifo, SH_accelerometer_data byte)
{
...
uint32_t SH_app_fifo_get(sh_app_fifo_t * p_fifo, SH_accelerometer_data * p_byte)
{
    if (FIFO_LENGTH != 0)
    {
...
uint32_t SH_app_fifo_peek(sh_app_fifo_t * p_fifo, uint16_t index, SH_accelerometer_data * p_byte)
{
...
uint32_t SH_app_fifo_flush(sh_app_fifo_t * p_fifo)
{
...
uint32_t SH_app_fifo_read(sh_app_fifo_t * p_fifo, SH_accelerometer_data * p_byte_array, uint32_t * p_size)
{
...
uint32_t SH_app_fifo_write(sh_app_fifo_t * p_fifo, SH_accelerometer_data const * p_byte_array, uint32_t * p_size)
{
    VERIFY_PARAM_NOT_NULL(p_fifo);
    VERIFY_PARAM_NOT_NULL(p_size);
